  ...
  sidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'Best SWQoS for Pump.fun', link: '/research/swqos-providers' },
        { text: 'Best SWQoS for PumpSwap', link: '/research/swqos-providers-pumpswap' },
        { text: 'Best SWQoS for Meteora DLMM', link: '/research/swqos-providers-dlmm' },

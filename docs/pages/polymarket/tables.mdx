...
| Table | Rows | Size |
|-------|------|------|
| [polymarket_order_filled_v3](#polymarket_order_filled_v3) | 1,837,051,333 | 301.45 GB |
| [raw_event_meta](#raw_event_meta) | 2,552,808 | 11.69 GB |
| [raw_market_meta](#raw_market_meta) | 10,935,666 | 11.93 GB |
...
SELECT * FROM polymarket.polymarket_order_filled_v3 LIMIT 10
...
<ClickHouseSqlExample database="polymarket">
SELECT * FROM polymarket.raw_event_meta LIMIT 10
</ClickHouseSqlExample>
...
<ClickHouseSqlExample database="polymarket">
SELECT * FROM polymarket.raw_market_meta LIMIT 10
</ClickHouseSqlExample>

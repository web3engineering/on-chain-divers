...
| Table | Rows | Size |
|-------|------|------|
| [agg_fulfilled_order](#agg-fulfilled-order) | 425,720,908 | 10.15 GB |
| [raw_node_fills_by_block](#raw-node-fills-by-block) | 2,175,505,136 | 152.84 GB |
| [view_perpetual_wallet](#view-perpetual-wallet) | 0 | 0 B |
| [view_wallet_position](#view-wallet-position) | 0 | 0 B |
...
SELECT * FROM agg_fulfilled_order LIMIT 10
...
<ClickHouseSqlExample database="hyperliquid">
SELECT * FROM view_perpetual_wallet LIMIT 10
</ClickHouseSqlExample>
...
<ClickHouseSqlExample database="hyperliquid">
SELECT * FROM view_wallet_position LIMIT 10
</ClickHouseSqlExample>
